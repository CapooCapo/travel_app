/**
 * API Client — khớp hoàn toàn với BE controllers:
 *
 * BE Controllers:
 *  AuthController          → /api/auth/*
 *  AttractionController    → /api/attractions/*
 *  AttractionImageController → /api/attraction-images/*
 *  BookmarkController      → /api/bookmarks/*
 *  ReviewController        → /api/attractions/{id}/reviews
 *  EventController         → /api/events/attraction/{attractionId}
 *  NotificationController  → /api/notifications (trả List trực tiếp, không có ApiResponse wrapper)
